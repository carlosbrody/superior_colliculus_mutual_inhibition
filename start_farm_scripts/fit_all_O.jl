...
:theta2                   => 0.15,
:opto_strength  => .7,
:opto_periods   => [-1  -1 ; 0   20 ],  # set of opto conditions, in seconds, with 0 the start 
...
:opto_targets => [.9 .7; .9 .5]  # first column is frachit Pro, next column is Anti, rows are conditions
