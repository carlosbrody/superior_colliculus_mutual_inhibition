...
# cost, answer_out, reac = run_dynamics(ntrials=20)

# println(cost)

# println(answer_out)

# # println(mean(answer_out,1))

# # println(answer_out[:,4])
...
# params2=[36.0,1.0,0.854,1.0];

# out = DiffBase.HessianResult(params2)  # out must be same length as whatever we will differentiate w.r.t.
# keyword_hessian!(out, (;pars...) -> run_dynamics(;pars...)[1], params1, params2)  # note initial values must be floats
...
# params = [20, 10, 0.5, 0.5]
# params=[36,1,0.854,1]
# params=[30,15,0.5,0.5]

# targets = [0.8, 0.7, 0.8, 0.5, 0.8, 0.7]   # Fraction correct in Pro and Anti

# targets = [0.9, 0.7, 0.9, 0.5, 0.9, 0.7]   # Fraction correct in Pro and Anti


# targets = [0.9, 0.6, 0.9, 0.4, 0.9, 0.6]   # Fraction correct in Pro and Anti
