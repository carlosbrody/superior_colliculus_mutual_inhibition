include("setup_C20.jl")



README = """

Farm C20: In a single file, do a pre-search with 50 trials/condition, then if it passes
criteria, train further at 1600 trials/condition
...
fbasename = farmdir * "/" * "farm_C20_" * chomp(readstring(`hostname`)) * "_"
