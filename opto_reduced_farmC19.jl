include("setup_C19.jl")



README = """

Farm C19: In a single file, do a pre-search with 50 trials/condition, then if it passes
...
fbasename = farmdir * "/" * "farm_C19_" * chomp(readstring(`hostname`)) * "_"
