...
for jjj in [1:242;]
    ...
    filename="farm_AF_"*lpad(jjj,4,0)*".mat"

    outfile="farm_AG_"*lpad(jjj,4,0)*".mat"
    ...
    pars, traj, cost, cpm_traj, ftraj = bbox_Hessian_keyword_minimization(myseed, args, bbox, func,
        start_eta = 0.01, tol=1e-12, verbose=true, verbose_every=10, maxiter=1000)
    ...
    matwrite(outfile, Dict("args"=>args, "myseed"=>myseed, "pars"=>pars, "traj"=>traj,
    "cost"=>cost, "cpm_traj"=>cpm_traj, "ftraj"=>ftraj, "nPro"=>nPro, "nAnti"=>nAnti, "sr"=>sr, "cb"=>cb,
    "theta1"=>theta1, "theta2"=>theta2,
