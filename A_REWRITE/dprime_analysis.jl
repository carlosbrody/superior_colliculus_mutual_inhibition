...
function plot_dprime(;timestep=55,opto_condition=1,time_condition=1)
    ...
    figure(figsize=(5,4))     
    plt[:hist](pro_choice_d, bins=10, color="black", alpha=0.3, label="Pro")
    #plt[:hist](vcat(ant1_choice_d,ant2_choice_d), bins=10, color="r", alpha=0.3, label="Anti")
    plt[:hist](ant1_choice_d, bins=10, color="r", alpha=0.3, label="Anti-1")
    plt[:hist](ant2_choice_d, bins=10, color="m", alpha=0.3, label="Anti-2")
