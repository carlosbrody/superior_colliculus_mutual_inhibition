include("setup_C31_control_pro.jl")


README = """

Farm C31: 3 node network, similar to Farm C30. CONTROL ONLY, PRO ONLY
...
farmdir = "../Farms_C31_control_pro"
if !isdir(farmdir); mkdir(farmdir); end
fbasename = farmdir * "/" * "farm_C31_control_pro_" * chomp(readstring(`hostname`)) * "_"
...
#while true
    ...
    extra_pars[:nAnti]    = 0;#extra_pars[:few_trials]
    ...
    # try
        ...
        # always completes further training
            ...
            extra_pars[:nAnti]    = 0;#extra_pars[:many_trials]
