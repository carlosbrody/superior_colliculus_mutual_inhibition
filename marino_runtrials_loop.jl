...
for jjj in [1:197;]
    ...
    # load existing fit
    fbasename="/Users/mpagan/animals/farm_AB_"*lpad(jjj,4,0)
    # fbasename="/Users/mpagan/Desktop/nuovissimo/superior_colliculus_mutual_inhibition-master/FarmFields/farm_F_"*lpad(jjj,4,0)

    # fbasename = "farm_F_0700"
    ...
    fbasename="tuorlo"*lpad(jjj,4,0)
    savename = fbasename*".mat"


    matwrite(savename, Dict("cost1"=>bao[1], "cost2"=>bao[2], "dif1"=>bao[3], "dif2"=>bao[4],
