...
function make_input(trial_type; dt=0.02, nderivs=0, difforder=0, constant_excitation=0.19, anti_rule_strength=0.1, 
    ...
    rule_and_delay_period=0.4, target_period=0.1, post_target_period=0.4, const_pro_bias=0, rule_set = 0, rule_period = 0,rule_strength = 0,
    other_unused_params...)
    ...
    if trial_type=="Anti"
        input[2:3, t.<rule_and_delay_period] += rule_strength
        input[2:3, t.<rule_period] += rule_set

    elseif trial_type=="Pro"
        input[[1,4], t.<rule_and_delay_period] += rule_strength
        input[[1,4], t.<rule_period] += rule_set
    else
...
#        println()
        ...
        end_rule =   other_unused_params[:rule_period];
