...
:opto_strength            => [mypars[:opto_strength],            [0,  0.999],  [0,    1]],
:pro_rule_strength        => [mypars[:pro_rule_strength],        [0,   0.2,],  [-1,    1]],
:anti_rule_strength       => [mypars[:anti_rule_strength],       [0,   0.2,],  [-1,    1]],
)
...
Farm C16: A repeat of the non-bounded opto attempt, 
like farm C12, but this time with opto_strength
and pro_rule_stregth and anti_rule_strength as three new
