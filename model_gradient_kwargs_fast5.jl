...
while eta > 1e-6
    ...
    new_cost2,new_results=run_dynamics(vwi=new_params2[1],hwi=new_params2[2],pro_bias=new_params2[3],delay_input=new_params2[4],opto_effect=new_params2[5])    
 ...
 if rem(i, 1)==0
   @printf "%d: eta=%f, cost=%.5f, params=[%.3f, %.3f, %.3f, %.3f, %.3f]\n" i eta cost params2[1] params2[2] params2[3] params2[4] params2[5]
   # println("eta")
   # println(eta)
   # println("cost")
   # println(cost)
