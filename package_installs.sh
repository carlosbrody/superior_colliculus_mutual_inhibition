...
git config --global user.email "marinopagan@gmail.com"
git config --global user.name "Marino Pagan"
...
sudo ln -s /home/marinopagan/julia-f4c6c9d4bb/bin/julia /usr/bin/julia

sudo apt-get -y install hdf5-tools

git clone "http://marinopagan@github.com/carlosbrody/superior_colliculus_mutual_inhibition.git"
